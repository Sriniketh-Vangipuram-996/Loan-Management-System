...
async getAnalytics(req, res, next) {
    try {
        ...
        console.log('Processed counts:', { approvedLoans, pendingLoans, rejectedLoans, underReviewLoans });
...
try{
    ...
    async createUser(req, res, next) {
        try {
            const { name, email, password, role = 'customer', phone, occupation, annualIncome } = req.body;
  ...
  async updateUserRole(req, res, next) {
    ...
    async updateSystemSettings(req, res, next) {
        try {
            const { sessionTimeout, maxLoginAttempts, emailNotifications, smsNotifications, autoApproveLimit, interestRates } = req.body;
    ...
    try {
        ...
        try {
            ...
            settings.forEach(setting => {
                if (setting.setting_key === 'loan_interest_rates' && setting.setting_value) {
