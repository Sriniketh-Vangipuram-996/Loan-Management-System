    ...
    try {
        ...
        res.json({
            ...
            data: {
                ...
                company: user.company, // Add this line
...
async updateProfile(req, res, next) {
    try {
        const { name, phone, occupation, annualIncome, dateOfBirth, address, company } = req.body;
        
        console.log('📝 [Backend] Received raw update data:', req.body);
        ...
        if (dateOfBirth !== undefined && dateOfBirth !== null && dateOfBirth.toString().trim() !== '') {
    ...
    async applyForLoan(req, res, next) {
        try {
            const { loanType, amount, purpose, tenureMonths, interestRate } = req.body;
